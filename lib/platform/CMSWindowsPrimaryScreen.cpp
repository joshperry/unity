	...
	bool* altgr)
{
	...
	if (id == kKeyNone) {
		...
		c = mapToCharacter(vkCode, scanCode, m_keys, press, isMenu, hkl);
...
char
CMSWindowsPrimaryScreen::mapToCharacter(UINT vkCode, UINT scanCode,
